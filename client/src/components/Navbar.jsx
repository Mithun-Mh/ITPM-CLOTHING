        ...
        <div className="flex flex-row justify-between p-5 md:px-32 px-5 bg-PrimaryColor shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          <div>
            <NavLink to="/" spy={true} smooth={true} duration={500}>
              <h1 className="text-2xl font-semibold text-indigo-800 cursor-pointer">
          ...
          <nav className="hidden lg:flex flex-row items-center text-lg font-semibold gap-8 text-indigo-800">
